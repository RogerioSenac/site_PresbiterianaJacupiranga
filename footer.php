        ...
        <div class="card-group">
            <div class="card">
                <div class="card-body-1">
                    ...
                    <ul>
                        <li><i class="fas fa-map-marker-alt"></i> Rua Vinte e Três de Junho, 262</br> Vila Elias, Jacupiranga, SP</li>
            ...
            <div class="card">
                <div class="card-body-2">
                    ...
                    <div class="social-icons">
                        <a href="https://www.facebook.com/IPBJacupiranga" styles="--color:#ddd" class="facebook" target="_blank"><i class="fab fa-facebook fa-2x"></i></a>
